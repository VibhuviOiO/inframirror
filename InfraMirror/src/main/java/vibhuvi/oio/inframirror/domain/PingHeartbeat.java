 ...
 */
@Entity
@Table(name = "ping_heartbeat")
@org.springframework.data.elasticsearch.annotations.Document(indexName = "pingheartbeat")
...
public class PingHeartbeat implements Serializable {
    ...
    public PingHeartbeat id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public PingHeartbeat executedAt(Instant executedAt) {
    ...
    public PingHeartbeat heartbeatType(String heartbeatType) {
    ...
    public PingHeartbeat success(Boolean success) {
    ...
    public PingHeartbeat responseTimeMs(Integer responseTimeMs) {
    ...
    public PingHeartbeat packetLoss(Float packetLoss) {
    ...
    public PingHeartbeat jitterMs(Integer jitterMs) {
    ...
    public PingHeartbeat cpuUsage(Float cpuUsage) {
    ...
    public PingHeartbeat memoryUsage(Float memoryUsage) {
    ...
    public PingHeartbeat diskUsage(Float diskUsage) {
    ...
    public PingHeartbeat loadAverage(Float loadAverage) {
    ...
    public PingHeartbeat processCount(Integer processCount) {
    ...
    public PingHeartbeat networkRxBytes(Long networkRxBytes) {
    ...
    public PingHeartbeat networkTxBytes(Long networkTxBytes) {
    ...
    public PingHeartbeat uptimeSeconds(Long uptimeSeconds) {
    ...
    public PingHeartbeat status(String status) {
    ...
    public PingHeartbeat errorMessage(String errorMessage) {
    ...
    public PingHeartbeat errorType(String errorType) {
    ...
    public PingHeartbeat metadata(String metadata) {
    ...
    public PingHeartbeat instance(Instance instance) {
    ...
    public PingHeartbeat agent(Agent agent) {
        this.setAgent(agent);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PingHeartbeat)) {
            return false;
        }
        return getId() != null && getId().equals(((PingHeartbeat) o).getId());
    }
