...
/**
 * Criteria class for the {@link vibhuvi.oio.inframirror.domain.ApiKey} entity. This class is used
 * in {@link vibhuvi.oio.inframirror.web.rest.ApiKeyResource} to receive all the possible filtering options from
...
public class ApiKeyCriteria implements Serializable, Criteria {
    ...
    private InstantFilter lastUsedDate;
    ...
    public ApiKeyCriteria(ApiKeyCriteria other) {
        ...
        this.lastUsedDate = other.optionalLastUsedDate().map(InstantFilter::copy).orElse(null);
    ...
    public InstantFilter getLastUsedDate() {
        return lastUsedDate;
    }

    public Optional<InstantFilter> optionalLastUsedDate() {
        return Optional.ofNullable(lastUsedDate);
    }

    public InstantFilter lastUsedDate() {
        if (lastUsedDate == null) {
            setLastUsedDate(new InstantFilter());
        }
        return lastUsedDate;
    }

    public void setLastUsedDate(InstantFilter lastUsedDate) {
    ...
    public String toString() {
        return "ApiKeyCriteria{" +
            ...
            optionalLastUsedDate().map(f -> "lastUsedDate=" + f + ", ").orElse("") +
