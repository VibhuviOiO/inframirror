...
/**
 * A DTO for the {@link vibhuvi.oio.inframirror.domain.InstanceHeartbeat} entity.
 */
...
public class InstanceHeartbeatDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceHeartbeatDTO)) {
            return false;
        }

        InstanceHeartbeatDTO instanceHeartbeatDTO = (InstanceHeartbeatDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, instanceHeartbeatDTO.id);
    }
