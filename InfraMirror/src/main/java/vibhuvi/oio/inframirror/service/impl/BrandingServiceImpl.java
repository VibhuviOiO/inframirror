...
public class BrandingServiceImpl implements BrandingService {
    ...
    private final BrandingSearchRepository brandingSearchRepository;

    public BrandingServiceImpl(
        BrandingRepository brandingRepository,
        BrandingMapper brandingMapper,
        BrandingSearchRepository brandingSearchRepository
    ) {
        this.brandingRepository = brandingRepository;
        this.brandingMapper = brandingMapper;
        this.brandingSearchRepository = brandingSearchRepository;
    }
    ...
    public BrandingDTO save(BrandingDTO brandingDTO) {
        ...
        brandingSearchRepository.index(branding);
    ...
    public Optional<BrandingDTO> partialUpdate(BrandingDTO brandingDTO) {
        ...
        return brandingRepository
            ...
            .map(savedBranding -> {
                brandingSearchRepository.index(savedBranding);
    ...
    public void delete(Long id) {
        ...
        brandingSearchRepository.deleteFromIndexById(id);
    }
    ...
    public Page<BrandingDTO> search(String query, Pageable pageable) {
        ...
        return brandingSearchRepository.search(query, pageable).map(brandingMapper::toDto);
    }
}
