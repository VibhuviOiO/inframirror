...
public class AgentMonitorResource {
    ...
    public AgentMonitorResource(AgentMonitorService agentMonitorService, AgentMonitorRepository agentMonitorRepository) {
    ...
    /**
     * {@code SEARCH  /agent-monitors/_search?query=:query} : search for the agentMonitor corresponding
     * to the query.
     *
     * @param query the query of the agentMonitor search.
     * @return the result of the search.
     */
    @GetMapping("/_search")
    public List<AgentMonitorDTO> searchAgentMonitors(@RequestParam("query") String query) {
        LOG.debug("REST request to search AgentMonitors for query {}", query);
        try {
            return agentMonitorService.search(query);
