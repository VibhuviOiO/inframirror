...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENTLOCK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_AGENTLOCKS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENTLOCK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENTLOCK actions', async () => {
      const arg = { id: 3170 };
    ...
    it('dispatches UPDATE_AGENTLOCK actions', async () => {
      const arg = { id: 3170 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENTLOCK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENTLOCK actions', async () => {
      const arg = 42666;
