...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENTMONITOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_AGENTMONITORS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENTMONITOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENTMONITOR actions', async () => {
      const arg = { id: 5362 };
    ...
    it('dispatches UPDATE_AGENTMONITOR actions', async () => {
      const arg = { id: 5362 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENTMONITOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENTMONITOR actions', async () => {
      const arg = 42666;
