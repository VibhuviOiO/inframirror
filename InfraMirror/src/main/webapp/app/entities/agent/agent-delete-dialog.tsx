...
import { deleteEntity, getEntity } from './agent.reducer';
...
export const AgentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/agent${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="infraMirrorApp.agent.delete.question">
        <Translate contentKey="infraMirrorApp.agent.delete.question" interpolate={{ id: agentEntity.id }}>
