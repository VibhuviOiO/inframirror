      ...
      <h2 id="agent-heading" data-cy="AgentHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="infraMirrorApp.agent.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/agent/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="infraMirrorApp.agent.home.createLabel">Create new Agent</Translate>
          </Link>
        </div>
      </h2>
      <Row>
        ...
        {agentList && agentList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="infraMirrorApp.agent.home.notFound">No Agents found</Translate>
            </div>
          )
        )}
      </div>
