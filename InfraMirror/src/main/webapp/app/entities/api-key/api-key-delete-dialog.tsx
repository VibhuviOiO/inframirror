...
import { deleteEntity, getEntity } from './api-key.reducer';

export const ApiKeyDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/api-key${pageLocation.search}`);
  };
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(apiKeyEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="infraMirrorApp.apiKey.delete.question">
        <Translate contentKey="infraMirrorApp.apiKey.delete.question" interpolate={{ id: apiKeyEntity.id }}>
