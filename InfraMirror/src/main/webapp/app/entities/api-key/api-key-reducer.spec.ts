...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIKEY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_APIKEYS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIKEY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIKEY actions', async () => {
      const arg = { id: 24872 };
    ...
    it('dispatches UPDATE_APIKEY actions', async () => {
      const arg = { id: 24872 };
    ...
    it('dispatches PARTIAL_UPDATE_APIKEY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIKEY actions', async () => {
      const arg = 42666;
