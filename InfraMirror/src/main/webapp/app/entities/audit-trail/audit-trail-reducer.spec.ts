...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_AUDITTRAIL actions', async () => {
      const arg = { id: 4000 };
    ...
    it('dispatches UPDATE_AUDITTRAIL actions', async () => {
      const arg = { id: 4000 };
    ...
    it('dispatches PARTIAL_UPDATE_AUDITTRAIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUDITTRAIL actions', async () => {
      const arg = 42666;
