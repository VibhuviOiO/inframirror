...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_BRANDINGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRANDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRANDING actions', async () => {
      const arg = { id: 30976 };
    ...
    it('dispatches UPDATE_BRANDING actions', async () => {
      const arg = { id: 30976 };
    ...
    it('dispatches PARTIAL_UPDATE_BRANDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRANDING actions', async () => {
      const arg = 42666;
