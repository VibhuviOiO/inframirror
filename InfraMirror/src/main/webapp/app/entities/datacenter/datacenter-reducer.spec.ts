...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATACENTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DATACENTERS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATACENTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATACENTER actions', async () => {
      const arg = { id: 18386 };
    ...
    it('dispatches UPDATE_DATACENTER actions', async () => {
      const arg = { id: 18386 };
    ...
    it('dispatches PARTIAL_UPDATE_DATACENTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATACENTER actions', async () => {
      const arg = 42666;
