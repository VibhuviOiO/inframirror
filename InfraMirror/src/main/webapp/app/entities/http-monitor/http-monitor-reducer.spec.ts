...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HTTPMONITOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_HTTPMONITORS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HTTPMONITOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HTTPMONITOR actions', async () => {
      const arg = { id: 17343 };
    ...
    it('dispatches UPDATE_HTTPMONITOR actions', async () => {
      const arg = { id: 17343 };
    ...
    it('dispatches PARTIAL_UPDATE_HTTPMONITOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HTTPMONITOR actions', async () => {
      const arg = 42666;
