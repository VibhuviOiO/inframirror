...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './instance-heartbeat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTANCEHEARTBEAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INSTANCEHEARTBEATS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTANCEHEARTBEAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTANCEHEARTBEAT actions', async () => {
      const arg = { id: 10408 };
    ...
    it('dispatches UPDATE_INSTANCEHEARTBEAT actions', async () => {
      const arg = { id: 10408 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTANCEHEARTBEAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTANCEHEARTBEAT actions', async () => {
      const arg = 42666;
