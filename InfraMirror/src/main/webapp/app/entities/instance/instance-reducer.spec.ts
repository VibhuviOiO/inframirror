...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTANCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INSTANCES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTANCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTANCE actions', async () => {
      const arg = { id: 30996 };
    ...
    it('dispatches UPDATE_INSTANCE actions', async () => {
      const arg = { id: 30996 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTANCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTANCE actions', async () => {
      const arg = 42666;
