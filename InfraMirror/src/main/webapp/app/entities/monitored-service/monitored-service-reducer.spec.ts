...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './monitored-service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONITOREDSERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MONITOREDSERVICES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONITOREDSERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONITOREDSERVICE actions', async () => {
      const arg = { id: 16850 };
    ...
    it('dispatches UPDATE_MONITOREDSERVICE actions', async () => {
      const arg = { id: 16850 };
    ...
    it('dispatches PARTIAL_UPDATE_MONITOREDSERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONITOREDSERVICE actions', async () => {
      const arg = 42666;
