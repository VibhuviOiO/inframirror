...
import reducer, { getEntities, getEntity, reset, searchEntities } from './ping-heartbeat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PINGHEARTBEAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PINGHEARTBEATS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PINGHEARTBEAT actions', async () => {
      const arg = 42666;
