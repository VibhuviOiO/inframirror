...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './service-heartbeat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEHEARTBEAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SERVICEHEARTBEATS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEHEARTBEAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEHEARTBEAT actions', async () => {
      const arg = { id: 24686 };
    ...
    it('dispatches UPDATE_SERVICEHEARTBEAT actions', async () => {
      const arg = { id: 24686 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEHEARTBEAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEHEARTBEAT actions', async () => {
      const arg = 42666;
