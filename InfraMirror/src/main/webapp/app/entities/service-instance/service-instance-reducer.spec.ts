...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEINSTANCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SERVICEINSTANCES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEINSTANCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEINSTANCE actions', async () => {
      const arg = { id: 13478 };
    ...
    it('dispatches UPDATE_SERVICEINSTANCE actions', async () => {
      const arg = { id: 13478 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEINSTANCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEINSTANCE actions', async () => {
      const arg = 42666;
