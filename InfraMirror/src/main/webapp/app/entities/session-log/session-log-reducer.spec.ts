...
import reducer, { getEntities, getEntity, reset, searchEntities } from './session-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SESSIONLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SESSIONLOGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SESSIONLOG actions', async () => {
      const arg = 42666;
