...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './status-dependency.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATUSDEPENDENCY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STATUSDEPENDENCIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATUSDEPENDENCY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATUSDEPENDENCY actions', async () => {
      const arg = { id: 26447 };
    ...
    it('dispatches UPDATE_STATUSDEPENDENCY actions', async () => {
      const arg = { id: 26447 };
    ...
    it('dispatches PARTIAL_UPDATE_STATUSDEPENDENCY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATUSDEPENDENCY actions', async () => {
      const arg = 42666;
