...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATUSPAGEITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STATUSPAGEITEMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATUSPAGEITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATUSPAGEITEM actions', async () => {
      const arg = { id: 1276 };
    ...
    it('dispatches UPDATE_STATUSPAGEITEM actions', async () => {
      const arg = { id: 1276 };
    ...
    it('dispatches PARTIAL_UPDATE_STATUSPAGEITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATUSPAGEITEM actions', async () => {
      const arg = 42666;
