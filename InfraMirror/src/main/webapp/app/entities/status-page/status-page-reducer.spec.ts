...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATUSPAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STATUSPAGES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATUSPAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATUSPAGE actions', async () => {
      const arg = { id: 28884 };
    ...
    it('dispatches UPDATE_STATUSPAGE actions', async () => {
      const arg = { id: 28884 };
    ...
    it('dispatches PARTIAL_UPDATE_STATUSPAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATUSPAGE actions', async () => {
      const arg = 42666;
