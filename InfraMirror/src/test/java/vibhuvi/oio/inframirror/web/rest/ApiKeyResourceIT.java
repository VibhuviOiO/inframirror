...
class ApiKeyResourceIT {
    ...
    @Test
    @Transactional
    void getAllApiKeysByNameIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where name equals to
        defaultApiKeyFiltering("name.equals=" + DEFAULT_NAME, "name.equals=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllApiKeysByNameIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where name in
        defaultApiKeyFiltering("name.in=" + DEFAULT_NAME + "," + UPDATED_NAME, "name.in=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllApiKeysByNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where name is not null
        defaultApiKeyFiltering("name.specified=true", "name.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByNameContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where name contains
        defaultApiKeyFiltering("name.contains=" + DEFAULT_NAME, "name.contains=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllApiKeysByNameNotContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where name does not contain
        defaultApiKeyFiltering("name.doesNotContain=" + UPDATED_NAME, "name.doesNotContain=" + DEFAULT_NAME);
    }

    @Test
    @Transactional
    void getAllApiKeysByDescriptionIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where description equals to
        defaultApiKeyFiltering("description.equals=" + DEFAULT_DESCRIPTION, "description.equals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllApiKeysByDescriptionIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where description in
    ...
    @Test
    @Transactional
    void getAllApiKeysByDescriptionIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where description is not null
        defaultApiKeyFiltering("description.specified=true", "description.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByDescriptionContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where description contains
        defaultApiKeyFiltering("description.contains=" + DEFAULT_DESCRIPTION, "description.contains=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllApiKeysByDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where description does not contain
        defaultApiKeyFiltering("description.doesNotContain=" + UPDATED_DESCRIPTION, "description.doesNotContain=" + DEFAULT_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void getAllApiKeysByActiveIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where active equals to
        defaultApiKeyFiltering("active.equals=" + DEFAULT_ACTIVE, "active.equals=" + UPDATED_ACTIVE);
    }

    @Test
    @Transactional
    void getAllApiKeysByActiveIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where active in
        defaultApiKeyFiltering("active.in=" + DEFAULT_ACTIVE + "," + UPDATED_ACTIVE, "active.in=" + UPDATED_ACTIVE);
    }

    @Test
    @Transactional
    void getAllApiKeysByActiveIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where active is not null
        defaultApiKeyFiltering("active.specified=true", "active.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByLastUsedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastUsedDate equals to
        defaultApiKeyFiltering("lastUsedDate.equals=" + DEFAULT_LAST_USED_DATE, "lastUsedDate.equals=" + UPDATED_LAST_USED_DATE);
    }

    @Test
    @Transactional
    void getAllApiKeysByLastUsedDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastUsedDate in
        defaultApiKeyFiltering(
            "lastUsedDate.in=" + DEFAULT_LAST_USED_DATE + "," + UPDATED_LAST_USED_DATE,
            "lastUsedDate.in=" + UPDATED_LAST_USED_DATE
        );
    }

    @Test
    @Transactional
    void getAllApiKeysByLastUsedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastUsedDate is not null
        defaultApiKeyFiltering("lastUsedDate.specified=true", "lastUsedDate.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByExpiresAtIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where expiresAt equals to
        defaultApiKeyFiltering("expiresAt.equals=" + DEFAULT_EXPIRES_AT, "expiresAt.equals=" + UPDATED_EXPIRES_AT);
    }

    @Test
    @Transactional
    void getAllApiKeysByExpiresAtIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where expiresAt in
        defaultApiKeyFiltering("expiresAt.in=" + DEFAULT_EXPIRES_AT + "," + UPDATED_EXPIRES_AT, "expiresAt.in=" + UPDATED_EXPIRES_AT);
    }

    @Test
    @Transactional
    void getAllApiKeysByExpiresAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where expiresAt is not null
        defaultApiKeyFiltering("expiresAt.specified=true", "expiresAt.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedByIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdBy equals to
        defaultApiKeyFiltering("createdBy.equals=" + DEFAULT_CREATED_BY, "createdBy.equals=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedByIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdBy in
        defaultApiKeyFiltering("createdBy.in=" + DEFAULT_CREATED_BY + "," + UPDATED_CREATED_BY, "createdBy.in=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedByIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdBy is not null
        defaultApiKeyFiltering("createdBy.specified=true", "createdBy.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedByContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdBy contains
        defaultApiKeyFiltering("createdBy.contains=" + DEFAULT_CREATED_BY, "createdBy.contains=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedByNotContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdBy does not contain
        defaultApiKeyFiltering("createdBy.doesNotContain=" + UPDATED_CREATED_BY, "createdBy.doesNotContain=" + DEFAULT_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdDate equals to
        defaultApiKeyFiltering("createdDate.equals=" + DEFAULT_CREATED_DATE, "createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllApiKeysByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdDate in
        defaultApiKeyFiltering(
    ...
    @Test
    @Transactional
    void getAllApiKeysByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where createdDate is not null
        defaultApiKeyFiltering("createdDate.specified=true", "createdDate.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByLastModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedBy equals to
        defaultApiKeyFiltering("lastModifiedBy.equals=" + DEFAULT_LAST_MODIFIED_BY, "lastModifiedBy.equals=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllApiKeysByLastModifiedByIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedBy in
        defaultApiKeyFiltering(
    ...
    @Test
    @Transactional
    void getAllApiKeysByLastModifiedByIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedBy is not null
        defaultApiKeyFiltering("lastModifiedBy.specified=true", "lastModifiedBy.specified=false");
    }

    @Test
    @Transactional
    void getAllApiKeysByLastModifiedByContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedBy contains
        defaultApiKeyFiltering(
    ...
    @Test
    @Transactional
    void getAllApiKeysByLastModifiedByNotContainsSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedBy does not contain
        defaultApiKeyFiltering(
    ...
    @Test
    @Transactional
    void getAllApiKeysByLastModifiedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedDate equals to
        defaultApiKeyFiltering(
    ...
    @Test
    @Transactional
    void getAllApiKeysByLastModifiedDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedDate in
        defaultApiKeyFiltering(
    ...
    @Test
    @Transactional
    void getAllApiKeysByLastModifiedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedApiKey = apiKeyRepository.saveAndFlush(apiKey);

        // Get all the apiKeyList where lastModifiedDate is not null
        defaultApiKeyFiltering("lastModifiedDate.specified=true", "lastModifiedDate.specified=false");
    }
