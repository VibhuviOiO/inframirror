...
class StatusPageResourceIT {
    ...
    public static StatusPage createEntity() {
        return new StatusPage()
            ...
            .showResponseTimes(DEFAULT_SHOW_RESPONSE_TIMES)
            .showUptimePercentage(DEFAULT_SHOW_UPTIME_PERCENTAGE)
            .autoRefreshSeconds(DEFAULT_AUTO_REFRESH_SECONDS)
            .monitorSelection(DEFAULT_MONITOR_SELECTION)
    ...
    public static StatusPage createUpdatedEntity() {
        return new StatusPage()
            ...
            .showResponseTimes(UPDATED_SHOW_RESPONSE_TIMES)
    ...
    void getAllStatusPages() throws Exception {
        ...
        restStatusPageMockMvc
            ...
            .andExpect(jsonPath("$.[*].monitorSelection").value(hasItem(DEFAULT_MONITOR_SELECTION)))
    ...
    void getStatusPage() throws Exception {
        ...
        restStatusPageMockMvc
            ...
            .andExpect(jsonPath("$.monitorSelection").value(DEFAULT_MONITOR_SELECTION))
