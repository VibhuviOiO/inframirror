...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Services", icon: AppWindow, href: "/services" },
    ],
  },
  {
    title: "Operations",
    items: [
      ...
      { name: "Postgres Ops", icon: Database, href: "/postgres-operations" },
    ],
  },
];
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 p-4 mt-auto">
        ...
        <div className="space-y-2">
          <a
            ...
            title={!expanded ? "Integrations" : undefined}
          >
            <div className={clsx(
              "flex items-center justify-center",
              expanded ? "w-5 h-5" : "w-6 h-6"
            ...
            {expanded && <span className="truncate ml-1">Integrations</span>}
            {window.location.pathname.startsWith("/integrations") && (
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-indigo-600 dark:bg-indigo-400 rounded-r-full" />
            )}
          </a>
          ...
          >
            ...
            {expanded && <span className="truncate ml-1">Settings</span>}
            {window.location.pathname.startsWith("/settings") && (
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-indigo-600 dark:bg-indigo-400 rounded-r-full" />
            )}
          </a>
