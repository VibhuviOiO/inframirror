...
export function useMonitors(filters?: MonitorFilters) {
  ...
  return useQuery<Monitor[]>({
    ...
    queryFn: async () => {
      const res = await axios.get(apiUrl(`/monitors?${queryParams.toString()}`));
...
export function useTCPMonitors(filters?: Omit<MonitorFilters, 'monitorType'>) {
  ...
  return useQuery<Monitor[]>({
    ...
    queryFn: async () => {
      const res = await axios.get(apiUrl(`/monitors/tcp?${queryParams.toString()}`));
      if (Array.isArray(res.data)) return res.data;
      if (!res.data) return [];
      return [res.data];
    },
...
export function usePINGMonitors(filters?: Omit<MonitorFilters, 'monitorType'>) {
  ...
  return useQuery<Monitor[]>({
    ...
    queryFn: async () => {
      const res = await axios.get(apiUrl(`/monitors/ping?${queryParams.toString()}`));
      if (Array.isArray(res.data)) return res.data;
      if (!res.data) return [];
      return [res.data];
    },
...
export function useDNSMonitors(filters?: Omit<MonitorFilters, 'monitorType'>) {
  ...
  return useQuery<Monitor[]>({
    ...
    queryFn: async () => {
      const res = await axios.get(apiUrl(`/monitors/dns?${queryParams.toString()}`));
      if (Array.isArray(res.data)) return res.data;
      if (!res.data) return [];
      return [res.data];
    },
