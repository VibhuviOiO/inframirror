    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-3xl font-extrabold text-blue-700 tracking-tight flex items-center gap-2">
          <span className="inline-block bg-blue-100 text-blue-700 rounded-full px-3 py-1 text-lg shadow-sm">Environments</span>
        </h1>
              ...
              <table className="min-w-full table-auto">
                <thead>
                  <tr className="text-left bg-blue-100 dark:bg-blue-950 animate-fade-in">
                    <th className="px-6 py-4 text-base font-bold text-blue-800 dark:text-blue-100">Environment</th>
                ...
                <tbody>
                  {filteredRows.length === 0 && (
                    <tr>
                      <td colSpan={2} className="px-6 py-8 text-center text-gray-400">No environments found.</td>
                    </tr>
                  )}
                  {filteredRows.map((r) => (
